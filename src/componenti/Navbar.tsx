...
export default function Navbar({ 
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-white border-b border-gray-200 shadow-sm z-50 transition-all duration-300 h-16 sm:h-20 flex items-center justify-between px-4 sm:px-8">
      {user && (
        <div className="flex absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 items-center gap-1 sm:gap-4">
          <Link 
            to="/" 
            className="flex items-center gap-2 text-gray-600 hover:text-[--secondary] px-2 sm:px-3 py-1.5 rounded-lg hover:bg-gray-100 transition-all"
            title="Home"
          >
